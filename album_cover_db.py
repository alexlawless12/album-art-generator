...
if __name__ == "__main__":
    ...
    genre_buckets = {
        'rock': ['alternativerock', 'rock', 'classicrock', 'newwave', 'permenantwave', 'adultstandards', 'modernrock', 'albumrock', 'emo', 'altz', 'hardrock', 'punkrock', 'poprock', 'neomellow', 'psychedelicrock', 'softrock', 'bluesrock', 'rootsrock', 'stompandholler', 'countryrock', 'heartlandrock', 'glamrock', 'sleazerock', 'rockandroll', 'dancerock', 'britishinvasion', 'grunge', 'acidrock', 'pianorock', 'garagerock', 'freakbeat', 'merseybeat', 'rockenespanol', 'mpb', 'rockquebecois', 'rockbaiano', 'eggpunk', 'trashrock', 'rocknacional', 'rockabilly', 'rockabillyenespanol', 'novacanco', 'swissalternativerock', 'flamencofusion', 'italianpoprock', 'rhythmrock', 'grunge pop', 'grungerevival', 'newzealandrock', 'countryrock'],
